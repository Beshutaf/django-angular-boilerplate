# Generated by Django 2.0.1 on 2018-01-29 15:48
...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            name='Conclusions',
            fields=[
                ('task_ptr', models.OneToOneField(auto_created=True, on_delete=django.db.models.deletion.CASCADE, parent_link=True, primary_key=True, serialize=False, to='shift_report.Task')),
                ('assigned_team', models.CharField(max_length=128)),
            ],
            bases=('shift_report.task',),
        ),
        migrations.AddField(
            model_name='task',
            name='shift',
